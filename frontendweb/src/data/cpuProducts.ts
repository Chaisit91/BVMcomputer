...
export const cpuProducts: CpuProduct[] = [
  { id: 'cpu1', name: 'Intel Core i7-14700K', brand: 'Intel', socket: 'LGA 1700', series: 'CORE i7', cores: 20, threads: 28, clock: '3.4 - 5.6 GHz', price: 14990, badge: 'สินค้าขายดี', inStock: true },
  ...
  { id: 'cpu3', name: 'Intel Core i5-14600KF', brand: 'Intel', socket: 'LGA 1700', series: 'CORE i5', cores: 14, threads: 20, clock: '3.5 - 5.3 GHz', price: 8990, inStock: true },
  ...
  { id: 'cpu6', name: 'Intel Core i9-14900K', brand: 'Intel', socket: 'LGA 1700', series: 'CORE i9', cores: 24, threads: 32, clock: '3.2 - 6.0 GHz', price: 22990, badge: 'แนะนำ', inStock: true },
  ...
  { id: 'cpu8', name: 'Intel Core i5-12400F', brand: 'Intel', socket: 'LGA 1700', series: 'CORE i5', cores: 6, threads: 12, clock: '2.5 - 4.4 GHz', price: 4390, inStock: true },
  { id: 'cpu9', name: 'Intel Core i3-12100F', brand: 'Intel', socket: 'LGA 1700', series: 'CORE i3', cores: 4, threads: 8, clock: '3.3 - 4.3 GHz', price: 2990, inStock: true },
  ...
  { id: 'cpu12', name: 'Intel Core i7-13700F', brand: 'Intel', socket: 'LGA 1700', series: 'CORE i7', cores: 16, threads: 24, clock: '2.1 - 5.2 GHz', price: 11900, inStock: true },
];

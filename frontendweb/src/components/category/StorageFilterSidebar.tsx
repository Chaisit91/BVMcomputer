...
interface StorageFilterSidebarProps {
  title: string;
  count: number;
  sort: CategorySort;
  ...
  onChange: (next: StorageFilterState) => void;
  onClear: () => void;
}

export function StorageFilterSidebar({
  title,
  count,
  sort,
  onSortChange,

...
import { caseBrandOptions, caseFormFactorOptions, type CaseFilterState } from '../../data/caseProducts';
    ...
    <aside className="flex w-full shrink-0 flex-col gap-4 lg:w-72">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4">
        ...
        <CollapsibleSection title="Mainboard Support">
          {caseFormFactorOptions.map((formFactor) => (
            <Checkbox
              key={formFactor}
              label={formFactor}

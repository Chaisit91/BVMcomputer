    ...
    <section className="bg-slate-50 pt-6">
      <Container>
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-ink via-ink-light to-brand-dark px-6 py-14 sm:px-12 sm:py-16">
          ...
          {/* Large decorative GPU glyph, not a copy of any real card photo/logo. */}
          <BsGpuCard
          ...
          <div className="relative flex max-w-xl flex-col gap-3">
            <span className="w-fit rounded-full bg-brand px-3 py-1 text-xs font-semibold text-white">GPU</span>
            ...
            <p className="text-sm leading-relaxed text-slate-300 sm:text-base">
              ภาพลื่นไหล คมชัด เฟรมเรตสูง เพื่อทุกการเล่นเกมและงานกราฟิก
              เลือกการ์ดจอ NVIDIA และ AMD ของแท้ ประกันศูนย์ไทย
            </p>
          </div>
        </div>
      </Container>

...
export function CoolingProductCard({ product }: { product: CoolingProduct }) {
    ...
    >
      <div className="relative flex aspect-square items-center justify-center bg-slate-50 p-3">
        ...
        {product.imageUrl ? (
          ...
          <BsSnow2 size={56} className="text-slate-300" aria-hidden="true" />
        )}
      </div>

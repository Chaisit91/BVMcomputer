...
/** A section that's always open (e.g. Brand) — just a heading + content. */
function OpenSection({ title, children }: { title: string; children: ReactNode }) {
  return (
...
/** A section that starts collapsed (Series / Processor Number / Socket Type). */

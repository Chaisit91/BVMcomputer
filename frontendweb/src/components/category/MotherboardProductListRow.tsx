    ...
    >
      ...
      <div className="relative flex h-28 w-28 shrink-0 items-center justify-center rounded-lg bg-slate-50 p-2">
        ...
        {product.imageUrl ? (
          ...
          <BsMotherboard size={44} className="text-slate-300" aria-hidden="true" />
        )}
      </div>
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2.5 flex flex-wrap gap-1.5">
          <SpecChip icon={BsMotherboard} label={product.chipset} />
          <SpecChip icon={BsMemory} label={product.memoryType} />

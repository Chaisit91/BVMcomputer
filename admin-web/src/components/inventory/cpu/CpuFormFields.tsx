    ...
    <div className="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-2">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <input type="number" className={inputClass} {...register('costPrice', { valueAsNumber: true })} />
              </div>
            </div>
            <div>
              <label className="mb-1.5 block text-sm font-medium text-gray-700">ส่วนลด (Discount)</label>
              <input type="number" className={inputClass} {...register('discount', { valueAsNumber: true })} />
            </div>
            ...
            <div className="flex items-center justify-between border-t border-gray-50 pt-4">
              ...
              <Toggle checked={publishImmediately} onChange={(value) => setValue('publishImmediately', value)} />
            </div>
          </div>
        </section>
      </div>
      ...
      <div className="space-y-6">
        <section className="rounded-2xl border border-gray-100 bg-white p-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <select className={inputClass} {...register('socket')}>
            ...
            <div>
              ...
              <input type="text" placeholder="เช่น 4.2 GHz" className={inputClass} {...register('baseFrequency')} />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="text" placeholder="เช่น 8 MB" className={inputClass} {...register('l2Cache')} />
            </div>
            <div>
              <label className="mb-1.5 block text-sm font-medium text-gray-700">แคช L3 (L3 Cache)</label>
              <input type="text" placeholder="เช่น 96 MB" className={inputClass} {...register('l3Cache')} />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="text" placeholder="เช่น 120W" className={inputClass} {...register('tdp')} />
            </div>
            <div>
              <label className="mb-1.5 block text-sm font-medium text-gray-700">TDP สูงสุด (Max TDP)</label>
              <input type="text" placeholder="เช่น 162W" className={inputClass} {...register('maxTdp')} />
            </div>
            <div>
              <label className="mb-1.5 block text-sm font-medium text-gray-700">การรับประกัน (Warranty)</label>
              <select className={inputClass} {...register('warranty')}>
        ...
        <section className="rounded-2xl border border-gray-100 bg-white p-5">
            ...
            {benchmarks.map((item) => (
              <div key={item.id} className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-900 outline-none placeholder:text-gray-400 focus:border-rose-400"
                />
                <input
                  type="text"
                  value={item.score}
                  ...
                  placeholder="คะแนน"
                  className="w-24 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-900 outline-none placeholder:text-gray-400 focus:border-rose-400"
                />
                <input
                  type="text"
                  value={item.unit}
                  ...
                  placeholder="หน่วย"
                  className="w-20 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-900 outline-none placeholder:text-gray-400 focus:border-rose-400"
                />
          ...
          <VideoLinkInput onAdd={(link) => onVideoLinksChange([...videoLinks, link])} />

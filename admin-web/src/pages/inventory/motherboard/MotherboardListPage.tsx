...
export function MotherboardListPage() {
  ...
  const cpuSupports = useToggleSet(cpuSupportFacet)
  const sockets = useToggleSet(socketFacet)
  const chipsets = useToggleSet(chipsetFacet)
  const mainboardSupports = useToggleSet(mainboardSupportFacet)
  const memorySlots = useToggleSet(memorySlotsFacet)
  const memoryTypes = useToggleSet(memoryTypeFacet)
  const maxMemories = useToggleSet(maxMemoryFacet)
  const formFactors = useToggleSet(formFactorFacet)
